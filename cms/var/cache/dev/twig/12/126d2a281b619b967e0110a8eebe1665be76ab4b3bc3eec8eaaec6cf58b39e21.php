...
class __TwigTemplate_5253166b04a913329f33c254afc180d8719b97f3acd76e13db9425394f2f4058 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"container\">
<a href=\"add-hourrate\" id=\"add-button\"> Add </a>
   ...
   <table >
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["rate"]) {
            ...
            echo "</td>
            <td><a id=\"edit\" href=\"/edit-hourrate/";
            // line 33
            ...
            echo "\">Edit</a></td>
            <td> <a id=\"delete\" href=\"/delete-transport/";
            // line 34
...
<a href=\"add-hourrate\" id=\"add-button\"> Add </a>
   ...
   <table >
    ...
    {% for rate in rates %}
        <tr>
            <td>{{ rate.price }}</td>
            <td><a id=\"edit\" href=\"/edit-hourrate/{{rate.Id}}\">Edit</a></td>
            <td> <a id=\"delete\" href=\"/delete-transport/{{rate.Id}}\">delete</a></td>
        </tr>
    {% endfor %}
</table>
</div>
