...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\FunctionController' => 'getFunctionControllerService',
            'App\\Controller\\HourrateController' => 'getHourrateControllerService',
    ...
    protected function getApiControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\ApiController', $this));
     ...
     */
    protected function getFunctionControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/FunctionController.php';

        $this->services['App\\Controller\\FunctionController'] = $instance = new \App\Controller\FunctionController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\FunctionController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\HourrateController' shared autowired service.
     *
     * @return \App\Controller\HourrateController
     */
    protected function getHourrateControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/HourrateController.php';

        $this->services['App\\Controller\\HourrateController'] = $instance = new \App\Controller\HourrateController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\HourrateController', $this));
    ...
    protected function getPageControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\PageController', $this));
    ...
    protected function getRegistrationControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\RegistrationController', $this));
    ...
    protected function getSecurityControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\SecurityController', $this));
    ...
    protected function getTaskControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\TaskController', $this));
     ...
     */
    protected function getTransportControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/TransportController.php';

        $this->services['App\\Controller\\TransportController'] = $instance = new \App\Controller\TransportController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\TransportController', $this));
    ...
    protected function getUserControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\UserController', $this));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('3xbVmpBFx-', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7rhwEwATsE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\HourrateRepository' => ['privates', 'App\\Repository\\HourrateRepository', 'getHourrateRepositoryService', false],
            'App\\Repository\\TasksRepository' => ['privates', 'App\\Repository\\TasksRepository', 'getTasksRepositoryService', false],
            'App\\Repository\\TransportrateRepository' => ['privates', 'App\\Repository\\TransportrateRepository', 'getTransportrateRepositoryService', false],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', false],
        ], [
            'App\\Repository\\HourrateRepository' => '?',
            'App\\Repository\\TasksRepository' => '?',
            'App\\Repository\\TransportrateRepository' => '?',
    ...
    protected function getErrorControllerService()
    {
        ...
        return $this->services['error_controller'] = new \Symfony\Component\HttpKernel\Controller\ErrorController(($this->services['http_kernel'] ?? $this->getHttpKernelService()), 'error_controller', new \Symfony\Component\ErrorHandler\ErrorRenderer\SerializerErrorRenderer(($this->services['serializer'] ?? $this->getSerializerService()), \Symfony\Component\ErrorHandler\ErrorRenderer\SerializerErrorRenderer::getPreferredFormat($a), new \Symfony\Bridge\Twig\ErrorRenderer\TwigErrorRenderer(($this->services['twig'] ?? $this->getTwigService()), ($this->privates['error_handler.error_renderer.html'] ?? $this->getErrorHandler_ErrorRenderer_HtmlService()), \Symfony\Bridge\Twig\ErrorRenderer\TwigErrorRenderer::isDebug($a, true))));
    }
    ...
    protected function getSerializerService()
    {
        ...
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 1 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 2 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 3 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $b), 4 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 5 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 6 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 7 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($a, $b, ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), new \Symfony\Component\PropertyInfo\PropertyInfoExtractor(new RewindableGenerator(function () {
    ...
    /**
     * Gets the private '.service_locator.BdNOwHJ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_BdNOwHJService()
    {
        return $this->privates['.service_locator.BdNOwHJ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private '.service_locator.MT2nb2b' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_MT2nb2bService()
    {
        return $this->privates['.service_locator.MT2nb2b'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private '.service_locator.xy_Lyra' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_XyLyraService()
    {
        return $this->privates['.service_locator.xy_Lyra'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ApiController::Token' => ['privates', '.service_locator.ccM2MGC', 'get_ServiceLocator_CcM2MGCService', false],
            'App\\Controller\\FunctionController::mail' => ['privates', '.service_locator.MT2nb2b', 'get_ServiceLocator_MT2nb2bService', false],
            'App\\Controller\\FunctionController::pdf' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\HourrateController::add' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\HourrateController::delete' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\HourrateController::edit' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\HourrateController::index' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\PageController::index' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            ...
            'App\\Controller\\TaskController::add' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\TaskController::clientDetail' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\TaskController::delete' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\TaskController::detail' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\TaskController::edit' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\TaskController::tasks' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\TransportController::add' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\TransportController::delete' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\TransportController::edit' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\TransportController::index' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\UserController::delete' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\UserController::edit' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\UserController::index' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\ApiController:Token' => ['privates', '.service_locator.ccM2MGC', 'get_ServiceLocator_CcM2MGCService', false],
            'App\\Controller\\FunctionController:mail' => ['privates', '.service_locator.MT2nb2b', 'get_ServiceLocator_MT2nb2bService', false],
            'App\\Controller\\FunctionController:pdf' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            'App\\Controller\\HourrateController:add' => ['privates', '.service_locator.BdNOwHJ', 'get_ServiceLocator_BdNOwHJService', false],
            ...
            'App\\Controller\\ApiController::Token' => '?',
            'App\\Controller\\FunctionController::mail' => '?',
            'App\\Controller\\FunctionController::pdf' => '?',
            'App\\Controller\\HourrateController::add' => '?',
            'App\\Controller\\HourrateController::delete' => '?',
            'App\\Controller\\HourrateController::edit' => '?',
            'App\\Controller\\HourrateController::index' => '?',
            'App\\Controller\\PageController::index' => '?',
            'App\\Controller\\RegistrationController::register' => '?',
            'App\\Controller\\SecurityController::login' => '?',
            'App\\Controller\\TaskController::add' => '?',
            'App\\Controller\\TaskController::clientDetail' => '?',
            'App\\Controller\\TaskController::delete' => '?',
            'App\\Controller\\TaskController::detail' => '?',
            'App\\Controller\\TaskController::edit' => '?',
            'App\\Controller\\TaskController::tasks' => '?',
            'App\\Controller\\TransportController::add' => '?',
    ...
    /**
     * Gets the private 'App\Repository\HourrateRepository' shared autowired service.
     *
     * @return \App\Repository\HourrateRepository
     */
    protected function getHourrateRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/HourrateRepository.php';

        return $this->privates['App\\Repository\\HourrateRepository'] = new \App\Repository\HourrateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\TransportrateRepository' shared autowired service.
     *
     * @return \App\Repository\TransportrateRepository
     */
    protected function getTransportrateRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Common/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/TransportrateRepository.php';

        return $this->privates['App\\Repository\\TransportrateRepository'] = new \App\Repository\TransportrateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Vi0UQ54IOp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7d8SCl5nSD', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VCZ4wpDMQL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7rTOjpUD3Y', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6WaJqGhAIY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7x2WMI8zmy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GBGti6DR84', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.xy_Lyra'] ?? $this->get_ServiceLocator_XyLyraService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getErrorHandler_ErrorRenderer_HtmlService()
    {
        ...
        return $this->privates['error_handler.error_renderer.html'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\HtmlErrorRenderer(true, 'UTF-8', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()), \dirname(__DIR__, 4), ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()));
    }
    ...
    protected function getSecurity_EncoderFactory_GenericService()
    {
        ...
        return $this->privates['security.encoder_factory.generic'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(['App\\Entity\\User' => ['algorithm' => 'sha512', 'migrate_from' => [], 'hash_algorithm' => 'sha512', 'key_length' => 40, 'ignore_case' => false, 'encode_as_base64' => true, 'iterations' => 5000, 'cost' => NULL, 'memory_cost' => NULL, 'time_cost' => NULL]]);
    }
